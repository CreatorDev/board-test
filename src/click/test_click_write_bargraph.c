...
static void print_usage(const char *program)
{
    ...
    LOG(LOG_INFO, " Example to light up top and bottom 2 segments of BarGraph's display:\n"
        " %s -m 1 -s 0x303\n", program);
}
    ...
    while (1) {
        ...
        case 's':
            ...
            if (tmp >= 0 && tmp <= 0x3ff) {
                ...
                LOG(LOG_ERR, "Error: correct range for the value: 0 - 0x3ff");
                return -1;
            }
            break;
        case 'h':
